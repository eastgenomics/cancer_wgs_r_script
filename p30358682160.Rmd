...
INPUT_FILEPATH <- "###"  # Note: redacted PID before version control

#--------------------------------------

#OUTPUT FILEPATH
OUTPUT_FILEPATH <- "###" # Note: redacted
...
SNV_DOMAIN_1_2_3_DATA_C <- select(SNV_DOMAIN_1_2_3_DATA_C, "Gene", "Coordinates", "Transcript", "Mutation", "VAF", "Clinical Significance", "Validation Status")


#GERMLINE_TIER_1$'Clinical Significance' <- paste("")
#GERMLINE_TIER_1$'Validation Status' <- paste("")

GERMLINE_TIER_3$'Clinical Significance' <- paste("")
GERMLINE_TIER_3$'Validation Status' <- paste("")

names(GERMLINE_TIER_3)[names(GERMLINE_TIER_3) == "GRCh38 coordinatesref/alt allele"] <- "Coordinates"
names(GERMLINE_TIER_3)[names(GERMLINE_TIER_3) == "CDS change and protein change"] <- "Mutation"

GERMLINE_TIER_3 <- select(GERMLINE_TIER_3, "Gene", "Coordinates", "Transcript", "Mutation", "Genotype", "Clinical Significance", "Validation Status")
...
SV_DOMAIN_1_2_3_GENE_DATA_GAIN <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "GAIN")
SV_DOMAIN_1_2_3_GENE_DATA_LOSS <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "LOSS")
SV_DOMAIN_1_2_3_GENE_DATA_LOH <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "LOH")
SV_DOMAIN_1_2_3_GENE_DATA_BND <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "BND")
SV_DOMAIN_1_2_3_GENE_DATA_DEL <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "DEL")
SV_DOMAIN_1_2_3_GENE_DATA_DUP <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "DUP")
SV_DOMAIN_1_2_3_GENE_DATA_INV <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type == "INV")
SV_DOMAIN_1_2_3_GENE_DATA_OTHER <- filter(SV_DOMAIN_1_2_3_GENE_DATA, Variant_Type != "LOSS" | Variant_Type != "GAIN" | Variant_Type != "LOH" | Variant_Type != "BND" | Variant_Type != "DEL" | Variant_Type != "DUP" | Variant_Type != "INV")
...
ggsave(filename=paste(OUTPUT_FILEPATH,P_NUMBER,"_SV_DOMAIN_1_2_3_GENE_DATA_GAIN_PLOIDYX2.pdf"),width=8, height=7, dpi=300)
...
ggsave(filename=paste(OUTPUT_FILEPATH,P_NUMBER,"_SV_DOMAIN_1_2_3_GENE_DATA_LOSS.pdf"),width=8, height=7, dpi=300)
