...
INPUT_FILEPATH <- "###" # Note: PID redacted
...
CancerHotspots <- read_excel("Reference_data_merged_01012023.xlsx",
    sheet = "CancerHotspots_28032021")
...
ReferenceGenes <- read_excel("Reference_data_merged_01012023.xlsx",
    sheet = "CANCER_CENSUS_GENES.v1.11")
...
TMB <- read_excel("Reference_data_merged_01012023.xlsx", 
    sheet = "TMB")
...
writeDataTable(wb = wb, sheet = 1, x = SV_DOMAIN_1_2_3_GENE_DATA %>% mutate(Classification = "", "Validation Status" = ""))
